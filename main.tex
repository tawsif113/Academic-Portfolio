...
\begin{itemize}
  ...
  \item Established Random Forest, XGBoost, and MLP baselines, then locked a
  70/10/20 target-train/validation/shadow protocol with validation-only F2
  threshold selection and untouched KDDTest+ utility evaluation.
